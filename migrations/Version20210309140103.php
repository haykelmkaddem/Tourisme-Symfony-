 ...
 */
final class Version20210309140103 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE notif (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, message VARCHAR(255) NOT NULL, seen TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('DROP TABLE avis_guide');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE avis_guide (id INT AUTO_INCREMENT NOT NULL, id_guide_id INT NOT NULL, note INT NOT NULL, INDEX IDX_BD56464B8736F1DE (id_guide_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, id_user INT NOT NULL, description LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
