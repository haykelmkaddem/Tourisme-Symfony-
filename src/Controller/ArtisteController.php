...
class ArtisteController extends AbstractController
{
    ...
    /**
     * @Route("/front", name="artiste_indexFront", methods={"GET"})
     */
    public function indexFront(ArtisteRepository $artisteRepository): Response
    {
        return $this->render('artiste/indexFront.html.twig', [
            'artistes' => $artisteRepository->findAll(),
        ]);
    }
