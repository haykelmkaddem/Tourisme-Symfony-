...
class __TwigTemplate_bd68adfa23aab683cfb917c0c0c584c2d20021ce8f80fc669d59cb91cf5c48c4 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("dashboard_utilisateur_delete", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 1, $this->source); })()), "id", [], "any", false, false, false, 1)]), "html", null, true);
    ...
    <input type=\"hidden\" name=\"_token\" value=\"";
        ...
        echo "\">
    <button class=\"btn text-danger\">supprimer <i class=\"fas fa-user-times\"></i></button>
</form>
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('dashboard_utilisateur_delete', {'id': utilisateur.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ utilisateur.id) }}\">
    <button class=\"btn text-danger\">supprimer <i class=\"fas fa-user-times\"></i></button>
</form>
", "admin/_delete_form.html.twig", "C:\\wamp64\\www\\TourismWeb1\\TourismWeb\\templates\\admin\\_delete_form.html.twig");
    }
}
