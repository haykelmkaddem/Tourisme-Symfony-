...
class __TwigTemplate_0b55d42f61a4674008082804b3cd7eec2779d84a87e12aef86b7b718a18cada8 extends Template
{
    private $source;
    private $macros = [];
...
$context["role"], "ROLE_USER"))) {
        ...
        <tr>
            ...
            <td>";
        // line 61
        ((twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 61, $this->source); })()), "datenaissance", [], "any", false, false, false, 61)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 61, $this->source); })()), "datenaissance", [], "any", false, false, false, 61), "Y-m-d"), "html", null, true))) : (print ("")));
        echo "</td>
        </tr>
        <tr>
            <th>Pays</th>
            <td>";
        // line 65
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 65, $this->source); })()), "pays", [], "any", false, false, false, 65), "html", null, true);
        echo "</td>
        </tr>
        <tr>
            <th>Etat</th>
            <td>";
        // line 69
        echo ((twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 69, $this->source); })()), "isVerified", [], "any", false, false, false, 69)) ? ("Verifié") : ("Non verifié"));
        echo "</td>
        </tr>
        </tbody>
    </table>
...
";
    ...
    {
        return array (  213 => 74,  205 => 69,  198 => 65,  191 => 61,  179 => 56,  174 => 53,  172 => 52,  169 => 51,  167 => 50,  164 => 49,  161 => 48,  157 => 47,  149 => 42,  142 => 38,  135 => 34,  128 => 30,  121 => 26,  107 => 15,  103 => 14,  94 => 10,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "admin/showuser.html.twig", "C:\\wamp64\\www\\TourismWeb\\templates\\admin\\showuser.html.twig");
    }
}
